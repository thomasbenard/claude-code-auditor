...
This is a documentation-only project: a 13-chapter reference guide about Claude Code, organized as markdown files with an `index.md` table of contents. There is no build system, no tests, and no code -- only prose in markdown.

## Structure

- `index.md` -- Table of contents linking all chapters, quick reference table
- `01-introduction.md` through `13-changelog.md` -- Chapters in reading order
...
5. References (12): external blogs, videos, podcasts, and community resources
6. Appendix (13): changelog of updates to the guide

## Conventions

- Chapters use `##` for major sections and `###` for subsections
- Each chapter ends with a `Next: [Chapter Name](filename.md)` link (except chapter 13 which links back to index)
