...
This is a documentation-only project: a 10-chapter reference guide about Claude Code, organized as markdown files with an `index.md` table of contents. There is no build system, no tests, and no code -- only prose in markdown.

## Structure

- `index.md` -- Table of contents linking all chapters, quick reference table
- `01-introduction.md` through `10-troubleshooting.md` -- Chapters in reading order
...
2. Working with Tools (03-05): tools, subagents, skills
3. Configuration and Memory (06-07): settings, CLAUDE.md, project setup
4. Mastering Claude Code (08-10): prompting, advanced features, troubleshooting

## Conventions

- Chapters use `##` for major sections and `###` for subsections
- Each chapter ends with a `Next: [Chapter Name](filename.md)` link (except chapter 10 which links back to index)
